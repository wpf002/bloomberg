...
const DEFAULT_LAYOUTS = {
  lg: [
    ...
    { i: "flow",         x: 0,  y: 12, w: 12, h: 10, minW: 4, minH: 6 },
    { i: "fundamentals", x: 0,  y: 22, w: 4, h: 8, minW: 3, minH: 4 },
    { i: "options",      x: 4,  y: 22, w: 5, h: 8, minW: 3, minH: 4 },
    { i: "filings",      x: 9,  y: 22, w: 3, h: 8, minW: 2, minH: 4 },
    { i: "calendar",     x: 0,  y: 30, w: 12, h: 4, minW: 4, minH: 3 },
    { i: "sizing",       x: 0,  y: 34, w: 5, h: 6, minW: 3, minH: 4 },
    { i: "explain",      x: 5,  y: 34, w: 4, h: 6, minW: 3, minH: 4 },
    { i: "compare",      x: 9,  y: 34, w: 3, h: 6, minW: 3, minH: 4 },
  ...
  md: [
    ...
    { i: "flow",         x: 0,  y: 14, w: 12, h: 10 },
    { i: "macro",        x: 0,  y: 24, w: 6, h: 5 },
    { i: "portfolio",    x: 6,  y: 24, w: 6, h: 5 },
    { i: "crypto",       x: 0,  y: 29, w: 6, h: 5 },
    { i: "fundamentals", x: 6,  y: 29, w: 6, h: 8 },
    { i: "options",      x: 0,  y: 34, w: 12, h: 8 },
    { i: "filings",      x: 0,  y: 42, w: 6, h: 6 },
    { i: "calendar",     x: 6,  y: 42, w: 6, h: 6 },
    { i: "sizing",       x: 0,  y: 48, w: 6, h: 7 },
    { i: "explain",      x: 6,  y: 48, w: 6, h: 7 },
    { i: "compare",      x: 0,  y: 55, w: 12, h: 7 },
  ...
  // Mobile heights are sized to fit each panel's content without inner
  // scroll. Chart needs ~320px for the TradingView widget plus a header
  // whose 13 interval buttons wrap to ~3 rows on phone widths; Markets
  // shows 11 tiles in a 3-col grid (4 rows). Both were undersized before.
  sm: [
    { i: "watchlist",    x: 0, y: 0,   w: 6, h: 6 },
    { i: "chart",        x: 0, y: 6,   w: 6, h: 11 },
    { i: "news",         x: 0, y: 17,  w: 6, h: 6 },
    { i: "markets",      x: 0, y: 23,  w: 6, h: 7 },
    { i: "flow",         x: 0, y: 30,  w: 6, h: 12 },
    { i: "macro",        x: 0, y: 42,  w: 6, h: 5 },
    { i: "portfolio",    x: 0, y: 47,  w: 6, h: 4 },
    { i: "crypto",       x: 0, y: 51,  w: 6, h: 5 },
    { i: "fundamentals", x: 0, y: 56,  w: 6, h: 8 },
    { i: "options",      x: 0, y: 64,  w: 6, h: 8 },
    { i: "filings",      x: 0, y: 72,  w: 6, h: 6 },
    { i: "calendar",     x: 0, y: 78,  w: 6, h: 4 },
    { i: "sizing",       x: 0, y: 82,  w: 6, h: 7 },
    { i: "explain",      x: 0, y: 89,  w: 6, h: 7 },
    { i: "compare",      x: 0, y: 96,  w: 6, h: 7 },
    ...
    { i: "gex",          x: 0, y: 169, w: 6, h: 12 },
    { i: "futures",      x: 0, y: 181, w: 6, h: 10 },
  ],
};
